...
export const projects: Project[] = [
    ...
    },
    {
      ...
      description: "Full-stack web app for searching and generating NuFi verb conjugations across multiple tenses, with automatic translations, downloadable Word output, and integrated linguistic reference content based on a published grammar resource.",
      tags: ["Full Stack", "Web App", "NLP", "Linguistics"],
      category: ["nlp", "fullstack"],
      repoUrl: null,
